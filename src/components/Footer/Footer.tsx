...
export default function Footer() {
  ...
  useEffect(() => {
    // Aplicar la clase 'dark' al elemento html cuando cambia el modo
    document.documentElement.classList.toggle('dark', isDarkMode)
  }, [isDarkMode])

  return (
    <footer className="bg-black dark:bg-gray-200 text-white dark:text-gray-800 transition-colors duration-300 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Acerca de Noah Store</h3>
            <p className="text-sm text-gray-400 dark:text-gray-600">Innovación • Calidad • Futuro</p>
          </div>
          <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 dark:text-gray-600 hover:text-white dark:hover:text-gray-800 transition-colors">
        ...
        <div className="mt-8 border-t border-gray-800 dark:border-gray-300 pt-8 flex flex-col md:flex-row justify-between items-center">
          <span className="text-sm text-gray-400 dark:text-gray-600">© 2024 Noah Store</span>
          <span className="text-sm text-gray-400 dark:text-gray-600 mt-2 md:mt-0">Innovación • Calidad • Futuro</span>
          <button
            onClick={() => setIsDarkMode(!isDarkMode)}
            className="mt-4 md:mt-0 p-2 rounded-full bg-gray-700 dark:bg-gray-300 text-white dark:text-gray-800"
